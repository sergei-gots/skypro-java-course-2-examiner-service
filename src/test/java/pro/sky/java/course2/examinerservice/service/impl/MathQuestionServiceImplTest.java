...
class MathQuestionServiceImplTest {
    ...
    void add_and_get() {
        //GIVEN
        final int count = mathQuestionService.size();
        //WHEN
        ...
        //THEN
        assertThat(mathQuestionService.size()).isEqualTo(count + 1);
    ...
    void tryToAddQuestionWithSameQuestionTwice() {
        //GIVEN
        final int count1 = mathQuestionService.size();
        //WHEN
        ...
        assertThat(mathQuestionService.size()).isEqualTo(count1 + 1);
        assertThat(mathQuestionService.get(actual1)).isEqualTo(expected1);

        //The Second Try:
        final int count2 = mathQuestionService.size();
        ...
        assertThat(mathQuestionService.size()).isEqualTo(count2);
    ...
    void add_and_remove() {
        ...
        assertThat(mathQuestionService.size()).isEqualTo(count);
    ...
    void getAll_and_remove_and_add() {
        ...
        assertThat(mathQuestionService.size()).isEqualTo(0);
        ...
        assertThat(mathQuestionService.size()).isEqualTo(10);
